...
public class TaskOne {
    ...
    private static void division(double firstNum, double secondNum) {
        if(secondNum ==  0) throw new ArithmeticException("Деление на ноль не возможно!");
        double result = firstNum/secondNum;
        System.out.printf("Деление %f на %f равен %f.\n", firstNum, secondNum, result);
    }
    ...
    public static void printStringArray(String[] sArray) {
        for (String item : sArray) {
            if (item == null) throw new NullPointerException("Элемента нет");
